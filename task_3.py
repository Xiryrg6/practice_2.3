...
ttk.Button(frame_menu, text="Посмотреть все валюты", width=30, command=lambda:show_all_currencies()).pack()
ttk.Button(frame_menu, text="Просмотреть валюту по коду", width=30, command=lambda:view_currency()).pack()
ttk.Button(frame_menu, text="Создать группу валют", width=30, command=lambda:create_group()).pack()
ttk.Button(frame_menu, text="Посмотреть все группы", width=30, command=lambda:show_groups()).pack()
ttk.Button(frame_menu, text="Добавить валюту в группу", width=30, command=lambda:add_currency_to_group()).pack()
ttk.Button(frame_menu, text="Удалить валюту из группы", width=30, command=lambda:remove_currency_from_group()).pack()
ttk.Button(frame_menu, text="Выход", width=30, command=lambda:root.destroy()).pack()
